 ...
 * @Package: com.yupi.sandbox
 * @Author: YY
 * @CreateTime: 2024-09-22  16:06
 * @Description: JavaCodeSandboxTemplate Java 代码沙箱模板方法的实现
 * @Version: 1.0
 */
@Slf4j
public abstract class JavaCodeSandboxTemplate implements CodeSandbox {
    ...
    /**
     * @description: 2. 编译代码，得到 class 文件
     * @author: YY
     * @method: compileFile
...
//            return getErrorResponse(e);
     ...
     * @param: userCodeFile
     * @param: inputList
     * @return: java.util.List<com.yupi.sandbox.model.ExecuteMessage>
     **/
...
//            String runCmd = String.format("java -Xmx256m -Dfile.encoding=UTF-8 -cp %s Main %s", userCodeParentPath, inputArgs);
    ...
    /**
     * @description: 4、得到输出结果
     * @author: YY
     * @method: getOutputResponse
